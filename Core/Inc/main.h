...
#define SDRAM_CHIP				0xD0000000

#define LAYER_SIZE				IMAGE_WIDTH * IMAGE_HEIGHT * 4	/* RGBA */

#define LAYER0_BUFFER   		((uint8_t*)SDRAM_CHIP)
#define LAYER1_BUFFER   		((uint8_t*)(LAYER0_BUFFER + LAYER_SIZE))


#define DECODE_BUFFER_1			((uint8_t*)(LAYER1_BUFFER + LAYER_SIZE))
#define DECODE_BUFFER_1_SIZE	600 * 600 * 3

#define DECODE_BUFFER_2			((uint8_t*)(DECODE_BUFFER_1 + DECODE_BUFFER_1_SIZE))
